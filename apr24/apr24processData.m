...
for i=3:2:15
    for j=1:length(raw{i}.data(:,1))
        hall(i,1,j) = raw{i}.data(j,3);
        hall(i,2,j) = raw{i}.data(j,4);
    end
end
...
figure;
subplot(7,1,1); plot(raw{3}.data(:,1),  raw{3}.data(:,2),   raw{3}.data(:,1),  raw{3}.data(:,3),   raw{3}.data(:,1),   raw{3}.data(:,4),   raw{3}.data(:,1),   raw{3}.data(:,5),   raw{3}.data(:,1),   raw{3}.data(:,6));  title('NoWings');
